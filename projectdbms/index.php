...
<html lang="en">
      ...
      <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
        <div class="container-fluid">
          <div class="navbar-header">
            <a class="navbar-brand page-scroll" href="https://www.gat.ac.in/">Global academy of technology</a>
          </div>
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="portal.png" alt="Los Angeles">
    </div>

    <div class="item">
      <img src="blue.png" alt="Chicago">
    </div>

    <div class="item">
      <img src="aboutus.png" alt="New York">
    </div>
  </div>
